package com.SistemaRh.sistemaRh.compartilhado.handlers;
...
public class ControllerExceptionHandler {
    ...
    // Tratamento de violações de integridade do banco
    ...
    public ResponseEntity<CustomError> dataIntegrityViolation(
        ...
        CustomError err = new CustomError(
                Instant.now(),
                status.value(),
                "Os dados informados conflitam com registros existentes.",
